...
// PRUEBA2Doc.cpp: implementación de la clase CPRUEBA2Doc
//
...
IMPLEMENT_DYNCREATE(CPRUEBA2Doc, CDocument)

BEGIN_MESSAGE_MAP(CPRUEBA2Doc, CDocument)
END_MESSAGE_MAP()


// Construcción o destrucción de CPRUEBA2Doc

CPRUEBA2Doc::CPRUEBA2Doc() noexcept
{
	// TODO: agregar aquí el código de construcción único

}

CPRUEBA2Doc::~CPRUEBA2Doc()
{
}

BOOL CPRUEBA2Doc::OnNewDocument()
{
...
// Serialización de CPRUEBA2Doc

void CPRUEBA2Doc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
void CPRUEBA2Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CPRUEBA2Doc::InitializeSearchContent()
{
...
void CPRUEBA2Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
// Diagnósticos de CPRUEBA2Doc

#ifdef _DEBUG
void CPRUEBA2Doc::AssertValid() const
{
	CDocument::AssertValid();
}

void CPRUEBA2Doc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG

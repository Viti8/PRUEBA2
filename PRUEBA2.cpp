...
// PRUEBA2.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CPRUEBA2App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CPRUEBA2App::OnAppAbout)
...
// Construcción de CPRUEBA2App

CPRUEBA2App::CPRUEBA2App() noexcept
{
	...
	SetAppID(_T("PRUEBA2.AppID.NoVersion"));

	// TODO: agregar aquí el código de construcción,
	// Colocar toda la inicialización importante en InitInstance
}

// Único objeto CPRUEBA2App

CPRUEBA2App theApp;


// Inicialización de CPRUEBA2App

BOOL CPRUEBA2App::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_PRUEBA2TYPE,
		RUNTIME_CLASS(CPRUEBA2Doc),
		RUNTIME_CLASS(CChildFrame), // Marco MDI secundario personalizado
		RUNTIME_CLASS(CPRUEBA2View));
	if (!pDocTemplate)
		return FALSE;
...
// Controladores de mensajes de CPRUEBA2App
...
void CPRUEBA2App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Métodos para cargar o guardar personalizaciones de CPRUEBA2App

void CPRUEBA2App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CPRUEBA2App::LoadCustomState()
{
}

void CPRUEBA2App::SaveCustomState()
{
}
